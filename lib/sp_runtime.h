...
static mrb_int sp_proc_call(sp_Proc *p, mrb_int arg) { return (p && p->fn) ? ((mrb_int (*)(void *, mrb_int))p->fn)(p->cap, arg) : 0; }
static mrb_int sp_proc_call_2(sp_Proc *p, mrb_int a, mrb_int b) { return (p && p->fn) ? ((mrb_int (*)(void *, mrb_int, mrb_int))p->fn)(p->cap, a, b) : 0; }
static mrb_int sp_proc_call_3(sp_Proc *p, mrb_int a, mrb_int b, mrb_int c) { return (p && p->fn) ? ((mrb_int (*)(void *, mrb_int, mrb_int, mrb_int))p->fn)(p->cap, a, b, c) : 0; }
