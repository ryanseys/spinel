...
#     are rejected with a hard analyze-time error.
...
#    rebound-self path, and returns nothing (lifted block return
#    type is locked to void today).
class Acc < Builder
end
...
#    receiver. Verifies arity-0 is not conflated with the
#    instance_eval lift -- they live in independent registries
